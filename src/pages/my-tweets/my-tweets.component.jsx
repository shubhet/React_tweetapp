...
import imgProfile2 from '../../assets/images/profile.jpg';
import imgProfile3 from '../../assets/images/profile.jpg';
import imgProfile4 from '../../assets/images/profile.jpg';
import imgProfile5 from '../../assets/images/profile.jpg';
...
import imgTrash from '../../assets/images/deleteicon.png';
import imgEdit from '../../assets/images/editicon.png';
                        ...
                        <div style={{ width: "100%", justifyContent: "flex-start", display: "inline-flex", flexDirection: "column", alignItems: "flex-start" }}>
                            <div style={{ display: "inline-flex", justifyContent: "space-between", width: "100%" }}>
                                ...
                                <div style={{ marginBottom: 10 }}>
                                    <img className={"ml-4"} src={imgEdit} height={25} width={25} onClick={onEditClick} />
                                    <img className={"ml-4"} src={imgTrash} height={35} width={35} onClick={onDeleteClick} />
                                </div>
                            ...
                            <>
                                ...
                                <div className="shadow" style={{ alignItems: "flex-start", display: "flex", flexDirection: "column", borderRadius: 10, margin: 30, marginTop: 0, }}>
                                    ...
                                    <div style={{ alignItems: "flex-start", display: "inline-flex", width: "100%", borderRadius: 10, borderWidth: 1, marginLeft: 30 }}>
                                        <img src={imgProfileEmpty}  height={30} width={30} style={{ marginRight: 20 }} />
